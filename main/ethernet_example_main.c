...
static void initialize_ethernet(void)
{
    ...
    ip_info.ip.addr = esp_ip4addr_aton("192.168.1.4");  // Replace with your desired static IP
    ...
    char ip_str_buffer[50];
    sprintf(ip_str_buffer, "%lu", ip_info.ip.addr);
    ESP_LOGI(TAG, "The current ESP32 IP Address is: %s", ip_str_buffer);
    ...
    ESP_ERROR_CHECK(esp_netif_set_ip_info(eth_netif, &ip_info)); // Set static IP
